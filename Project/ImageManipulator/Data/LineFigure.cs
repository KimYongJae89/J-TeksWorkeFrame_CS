...
namespace ImageManipulator.Data
{
    ...
    public class LineFigure : Figure
    {
        ...
        public override void Draw(Graphics g)
        {
            ...
            if (this.Selectable)
            {
                Status.Instance().LogManager.AddLogMessage("Select Line", "Start : " + _drawLineStartPoint.ToString() + " End :" + _drawLineEndPoint.ToString());
        ...
        private double CalcLength()
        {
            ...
            double pitchX = (double)Status.Instance().FovWidth / (double)Status.Instance().SelectedViewer.ImageManager.GetOrgImage().Width;
            double pitchY = (double)Status.Instance().FovHeight / (double)Status.Instance().SelectedViewer.ImageManager.GetOrgImage().Height;
