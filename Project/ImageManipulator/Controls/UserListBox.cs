...
{
    public class UserListBox : System.Windows.Forms.ListBox
    {
        ...
        public class DisabledIndexCollection : IList, ICollection, IEnumerable
        {
            ...
            private class SelectedIndexEnumerator : IEnumerator
            {
                // Fields
                private int current;
                private UserListBox.DisabledIndexCollection items;

                // Methods
                public SelectedIndexEnumerator(UserListBox.DisabledIndexCollection items)
                {
                    this.items = items;
                    this.current = -1;
                }
