...
namespace ImageManipulator.ImageProcessingData
{
    ...
    public class IpColorLevelingParams : IParamBase
    {
        ...
        public IpColorLevelingParams()
        {
            ...
            KDepthType bitType = Status.Instance().SelectedViewer.ImageManager.DisPlayImage.Depth;
    ...
    public class IpLevelingParams : IParamBase
    {
        public int Low;
        public int High;

        public IpLevelingParams()
        {
            if (Status.Instance().SelectedViewer == null)
            {
                Low = 0;
        ...
        public override object Clone()
        {
            IpLevelingParams level = new IpLevelingParams();
            level.Low = this.Low;
            level.High = this.High;
            return level;
        }
    ...
    public class IpLutParams : IParamBase
    {
        ...
        public IpLutParams()
        {
            ...
            curve.ImageBit = Status.Instance().SelectedViewer.ImageManager.GetBit();
