...
{
    public class IP_LUT : IPBase
    {
        
        private IpLutParams _param = new IpLutParams();
        public IP_LUT()
        {
            ProcessType = eImageProcessType.LUT;
        }
        ...
        public override JImage Execute(JImage inputImage)
        {
            ...
            if (_param.LUT == null)
            {
                ...
                CStatus.Instance().ProcessingTime.Add(time);
                return inputImage;
            }
            else
            {
        ...
        public override void Save(XmlDocument xmlDocument, XmlElement element)
        {
            try
            {
                XmlElement filterelement = xmlDocument.CreateElement("", "Lut", "");
    ...
    public class IP_RotationCW : IPBase
    {
        ...
        public override void Save(XmlDocument xmlDocument, XmlElement element)
        {
            XmlElement filterelement = xmlDocument.CreateElement("", "CW", "");
            element.AppendChild(filterelement);
        }
    ...
    public class IP_RotationCCW : IPBase
    {
        ...
        public override void Save(XmlDocument xmlDocument, XmlElement element)
        {
            XmlElement filterelement = xmlDocument.CreateElement("", "CCW", "");
            element.AppendChild(filterelement);
        }
    ...
    public class IP_Crop : IPBase
    {
        ...
        {
           // Rectangle
            XmlElement filterelement = xmlDocument.CreateElement("", "Crop", "");
            element.AppendChild(filterelement);
    ...
    public class IP_Resize : IPBase
    {
        ...
        public override void Save(XmlDocument xmlDocument, XmlElement element)
        {
            XmlElement filterelement = xmlDocument.CreateElement("", "Resize", "");
            element.AppendChild(filterelement);
    ...
    public class IP_FlipVetical : IPBase
    {
        ...
        public override void Save(XmlDocument xmlDocument, XmlElement element)
        {
            XmlElement filterelement = xmlDocument.CreateElement("", "FlipVetical", "");
            element.AppendChild(filterelement);
        }
    ...
    public class IP_FlipHorizontal : IPBase
    {
        ...
        public override void Save(XmlDocument xmlDocument, XmlElement element)
        {
            XmlElement filterelement = xmlDocument.CreateElement("", "FlipHorizontal", "");
            element.AppendChild(filterelement);
        }
    ...
    public class IP_Blur : IPBase
    {
        ...
        public override void Save(XmlDocument xmlDocument, XmlElement element)
        {
            XmlElement filterelement = xmlDocument.CreateElement("", "Blur", "");
            element.AppendChild(filterelement);
    ...
    public class IP_Sharp1 : IPBase
    {
        ...
        public override void Save(XmlDocument xmlDocument, XmlElement element)
        {
            XmlElement filterelement = xmlDocument.CreateElement("", "Sharp1", "");
            element.AppendChild(filterelement);
        }
    ...
    public class IP_Sharp2 : IPBase
    {
        ...
        public override void Save(XmlDocument xmlDocument, XmlElement element)
        {
            XmlElement filterelement = xmlDocument.CreateElement("", "Sharp2", "");
            element.AppendChild(filterelement);
        }
    ...
    public class IP_Sobel : IPBase
    {
        ...
        public override void Save(XmlDocument xmlDocument, XmlElement element)
        {
            XmlElement filterelement = xmlDocument.CreateElement("", "Sobel", "");
            element.AppendChild(filterelement);
    ...
    public class IP_Laplacian : IPBase
    {
        ...
        public override void Save(XmlDocument xmlDocument, XmlElement element)
        {
            XmlElement filterelement = xmlDocument.CreateElement("", "Laplacian", "");
            element.AppendChild(filterelement);
    ...
    public class IP_Canny : IPBase
    {
        ...
        public override void Save(XmlDocument xmlDocument, XmlElement element)
        {
            XmlElement filterelement = xmlDocument.CreateElement("", "Canny", "");
            element.AppendChild(filterelement);
    ...
    public class IP_HorizonEdge : IPBase
    {
        ...
        public override void Save(XmlDocument xmlDocument, XmlElement element)
        {
            XmlElement filterelement = xmlDocument.CreateElement("", "HorizonEdge", "");
            element.AppendChild(filterelement);
        }
    ...
    public class IP_VerticalEdge : IPBase
    {
        ...
        public override void Save(XmlDocument xmlDocument, XmlElement element)
        {
            XmlElement filterelement = xmlDocument.CreateElement("", "VerticalEdge", "");
            element.AppendChild(filterelement);
        }
    ...
    public class IP_Median : IPBase
    {
        ...
        public override void Save(XmlDocument xmlDocument, XmlElement element)
        {
            XmlElement filterelement = xmlDocument.CreateElement("", "Median", "");
            element.AppendChild(filterelement);
    ...
    public class IP_Dilate : IPBase
    {
        ...
        public override void Save(XmlDocument xmlDocument, XmlElement element)
        {
            XmlElement filterelement = xmlDocument.CreateElement("", "Dilate", "");
            element.AppendChild(filterelement);
    ...
    public class IP_Erode : IPBase
    {
        ...
        public override void Save(XmlDocument xmlDocument, XmlElement element)
        {
            XmlElement filterelement = xmlDocument.CreateElement("", "Erode", "");
            element.AppendChild(filterelement);
    ...
    public class IP_Average : IPBase
    {
        ...
        public override void Save(XmlDocument xmlDocument, XmlElement element)
        {
            XmlElement filterelement = xmlDocument.CreateElement("", "Average", "");
            element.AppendChild(filterelement);
        }
    ...
    public class IP_GreyLeveling : IPBase
    {
        private IpGreyLevelingParams _param= new IpGreyLevelingParams();
        public IP_GreyLeveling()
        {
        ...
        public override object Clone()
        {
            IP_GreyLeveling level = new IP_GreyLeveling();
        ...
        public override void Save(XmlDocument xmlDocument, XmlElement element)
        {
            XmlElement filterelement = xmlDocument.CreateElement("", "GreyLeveling", "");
            element.AppendChild(filterelement);
        ...
        public override void SetParam(object param)
        {
            _param = (IpGreyLevelingParams)param;
        }
    }
    ...
    public class IP_Threshold : IPBase
    {
        ...
        public override JImage Execute(JImage inputImage)
        {
            ...
            JImage ret = inputImage.Threshold(_param.Value);
        ...
        public override void Save(XmlDocument xmlDocument, XmlElement element)
        {
            XmlElement filterelement = xmlDocument.CreateElement("", "Threshold", "");
            element.AppendChild(filterelement);
    ...
    public class IP_ThresholdAdaptive : IPBase
    {
        ...
        public override void Save(XmlDocument xmlDocument, XmlElement element)
        {
            XmlElement filterelement = xmlDocument.CreateElement("", "ThresholdAdaptive", "");
            element.AppendChild(filterelement);
    ...
    public class IP_ThresholdOtsu : IPBase
    {
        ...
        public override void Save(XmlDocument xmlDocument, XmlElement element)
        {
            XmlElement filterelement = xmlDocument.CreateElement("", "ThresholdOtsu", "");
            element.AppendChild(filterelement);
